...
data=[data;p,v]
if p==1
    %plot(p,v,'s','MarkerSize',10,'MarkerFaceColor','r')
end
end
x=data(:,1);
y=data(:,2);
...
legend('Origin','Size change with the same proportion','The lengths change of upper and under surface','The width change of upper surface','The width change of under surface','The heigth change',16)
title('The sensitivity analysis on shapes of bathtub')
